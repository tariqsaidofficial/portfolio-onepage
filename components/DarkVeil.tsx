...
vec3 rgb2hsl(vec3 c){
    ...
    if(delta>0.0){
        ...
        if(c.r==maxC)h=(c.g-c.b)/delta+(c.g<c.b?6.0:0.0);
        else if(c.g==maxC)h=(c.b-c.r)/delta+2.0;
...
export default function DarkVeil({
  ...
  useEffect(() => {
    ...
    const loop = () => {
      ...
      programRef.current.uniforms.uTime.value = ((performance.now() - startRef.current) / 1000) * speed
