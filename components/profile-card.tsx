...
// DarkNavy + Gold + Red theme gradients
const DEFAULT_BEHIND_GRADIENT =
  "radial-gradient(farthest-side circle at var(--pointer-x) var(--pointer-y),hsla(0,0%,20%,var(--card-opacity)) 4%,hsla(0,0%,15%,calc(var(--card-opacity)*0.75)) 10%,hsla(0,0%,10%,calc(var(--card-opacity)*0.5)) 50%,hsla(0,0%,5%,0) 100%),radial-gradient(35% 52% at 55% 20%,#fbbf24cc 0%,#0a122c00 100%),radial-gradient(100% 100% at 50% 50%,#e11d48ff 1%,#0a122c00 76%),conic-gradient(from 124deg at 50% 50%,#0a122cff 0%,#fbbf24ff 40%,#fbbf24ff 60%,#0a122cff 100%)"

// DarkNavy to Gold gradient
const DEFAULT_INNER_GRADIENT = "linear-gradient(145deg,#0a122c8c 0%,#fbbf2444 100%)"
