    ...
    modalContent: {
      ...
      sections: [
        ...
        },
        {
          ...
          content: "I've guided and trained young actors through workshops, collaborative performances, and qualification programs for Theatre Studies Department, Faculty of Arts, Alexandria University and Higher Institute of Dramatic Arts – Egypt. Many of those I worked with have since become emerging talents in the performing arts scene."
        },
        {
          icon: BookOpen,
...
export default function OffTheGridDemo() {
  const [selectedInterest, setSelectedInterest] = useState<typeof interests[0] | null>(null)

  return (
    <div className="min-h-screen bg-background text-foreground relative" style={{ zIndex: 10 }}>
      {/* Header */}
      <div className="border-b border-border/40 bg-card/95 sticky top-0 z-40">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-bold text-foreground">Off the Grid Demo</h1>
            <Link
              href="/"
                  ...
                  {selectedInterest.modalContent.highlights && (
                    <div className="mb-12">
                      ...
                      <div className="grid md:grid-cols-2 gap-4">
                        {selectedInterest.modalContent.highlights.map((highlight, idx) => (
                          <motion.div
                            key={idx}
                  ...
                  {selectedInterest.modalContent.highlights && (
                    <div>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {selectedInterest.modalContent.images.map((image, idx) => (
                          <motion.div
                            key={idx}
